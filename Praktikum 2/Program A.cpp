...
void tampilData(){
    ...
    cout << "\tDaftar Pembeli\n";
    gotoxy(0,1); strip(30);
    gotoxy(60, 1); strip(30);
    gotoxy(0,2); cout << "Kode_pbl";
    gotoxy(10,2); cout << "Status";
    gotoxy(20,2); cout << "Nama" ;

    gotoxy(70,0); cout << "Daftar Barang\n";

    gotoxy(0,3); strip(30);
    gotoxy(60,3); strip(30);

    gotoxy(60,2); cout << "Kode_brg";
    gotoxy(70,2); cout << "Nama_brg";
    gotoxy(84,2); cout << "Harga" ;
    ...
    for (n = 0; n<5; n++){
        ...
        gotoxy(60,ln); cout << barang[n].kode_brg;
        gotoxy(70,ln); cout << barang[n].nama_brg;
        gotoxy(84,ln); cout << barang[n].harga;
        ln++;
    }

    gotoxy(0,9); strip(30);
    gotoxy(60,9); strip(30);
...
int main()
{
    ...
    cout << endl;
    strip(90);
    gotoxy(37,11); cout << "Transaksi Pembelian\n";
    strip(90);
    ...
    cout << endl;
    cout << endl;
    cout << "Cetak nota tekan 'enter'..." << endl;
    ...
    cout << endl;
    cout << endl;
    cout << "Terimakasih telah belanja silahkan tekan 'enter'..." << endl;
    getch();
}
